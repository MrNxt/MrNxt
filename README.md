...
<div align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=24&pause=1000&color=2F80ED&center=true&vCenter=true&width=500&lines=Hola%2C+soy+Alejandro+Prieto;Desarrollador+de+software;Apasionado+por+la+tecnolog%C3%ADa+y+los+deportes+extremos" alt="typing intro" />
</div>
 ...
 * @param {string} profesion - Análista y Desarrollador de Software.
 * @param {string} especialidades - Oracle APEX, Backend con PL/SQL, Java SE, JavaScript, TypeScript,
 * @param {string[]} intereses - Inteligencia Artificial, Educación, Artes Marciales.
 * @param {string} mensaje - Nunca estarás listo, pero igual hazlo.
 */
```
